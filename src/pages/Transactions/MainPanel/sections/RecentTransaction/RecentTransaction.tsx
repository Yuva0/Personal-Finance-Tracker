      ...
      <div className="main-panel-transaction-table-top">
        ...
        <div className="main-panel-transaction-table-filters">
          <ContentSwitcher className="main-panel-transaction-table-filters-content-switcher">
            <ContentSwitcherItem
              label="Yearly"
              className="main-panel-transaction-table-content-switcher-item"
              selected
            />
            <ContentSwitcherItem
              label="Monthly"
          ...
          <Input
            className={`main-panel-transaction-table-filters-input ${
              showInput ? "filters-show-input" : "filters-hide-input"
            }`}
          />
          <span>
            <IconButton
          ...
          <span className="recent-transaction-icon-btn-grp">
            <IconButton icon={<FontAwesomeIcon icon={faPlus} />} />
          </span>
          <span>
            <IconButton icon={<FontAwesomeIcon icon={faFilter} />} />
          </span>
          <span>
            <IconButton icon={<FontAwesomeIcon icon={faGear} />} />
          </span>
        </div>
      </div>
      <Table
        ...
        data={[
          [
            ...
            <Text
              variant="label"
              size="medium"
              className="main-panel-transaction-table-bills"
            >
              Bills
            </Text>,
            <Text variant="number" size="medium" weight="bold">
              - $100
            </Text>,
          ],
          [
            ...
            <Text
              variant="label"
              size="medium"
              className="main-panel-transaction-table-travel"
            >
              Travel
            </Text>,
            <Text variant="number" size="medium" weight="bold">
          ...
          [
            ...
            <Text
              variant="label"
              size="medium"
              className="main-panel-transaction-table-shopping"
            >
              Shopping
            </Text>,
            <Text variant="number" size="medium" weight="bold">
          ...
          [
            ...
            <Text
              variant="label"
              size="medium"
              className="main-panel-transaction-table-investments"
            >
              Investments
            </Text>,
            <Text variant="number" size="medium" weight="bold">
          ...
          [
            ...
            <Text
              variant="label"
              size="medium"
              className="main-panel-transaction-table-rent"
            >
              Rent
            </Text>,
            <Text variant="number" size="medium" weight="bold">
          ...
          [
            ...
            <Text
              variant="label"
              size="medium"
              className="main-panel-transaction-table-salary"
            >
              Salary
            </Text>,
            <Text variant="number" size="medium" weight="bold">
